<template>
  <header>
      <section>
          <div class="container upCase fs-1">
              <div class="nav-container d-flx space-bet alignIteCent">

                  <!-- Button order section -->
                  <div>
                      <button class="upCase btn-custom">
                        order online
                      </button>
                  </div>
                  ...
                  <nav class="flx-grow">
                      <ul class="d-flx justContCent alignIteCent">
                          ...
                          <li>
                              <!-- Logo Center -->
                              <a href="/"><img class="logo-header" src="../assets/img/h5-logo-divided-header.png" alt=""></a>
                          </li>
                  ...
                  <div class="cart-search-section d-flx justContCent alignIteCent">

                      <!-- Cart section -->
                      <div class="cart d-flx justContCent alignIteCent">
                          <div class="cart-box">
                              <a href="">
              ...
              <div class="slider-container">
                  <div class="img-box d-flx justContCent alignIteCent">
                    <img class="urban-bg" src="../assets/img/h3-rev-img-5.png" alt="">
                    <img class="img-absolute" src="../assets/img/h3-rev-img-6.png" alt="">
                  </div>
              </div>
          </div>
          <div class="btn-prev-next prev-tr">
                    prev
                  </div>
  
                  <div class="btn-prev-next next-tr">
                    next
                  </div>
      </section>
  </header>
